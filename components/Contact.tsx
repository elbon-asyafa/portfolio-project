...
const LINKS = [
  ...
  { icon:"🎵", label:"TikTok",    val:"@asyaffarn",     href:"https://tiktok.com/@asyaffarn",   tint:"rgba(74,100,144,0.25)" },
  { icon:"✉️", label:"Email",     val:"elbon@example.com", href:"mailto:elbon@example.com",     tint:"rgba(242,224,208,0.35)" },
];
      ...
      <div className="sp sp-inner">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="reveal flex flex-col items-center gap-4">
            <button onClick={() => { navigator.clipboard.writeText("elbon@example.com"); setCp(true); setTimeout(()=>setCp(false),2000); }}
              className="glass-btn inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-mono"
              style={{ color:"var(--text-2)" }}>
              {cp ? "✓ Copied!" : "📋 elbon@example.com"}
            </button>
