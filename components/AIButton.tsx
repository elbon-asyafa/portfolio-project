...
export default function AIButton() {
  ...
  // Shared glass style — NO svg filter (causes text blur on mobile)
  const glassBase: React.CSSProperties = {
    ...
    boxShadow: "0 16px 60px rgba(74,100,144,0.22), 0 4px 16px rgba(0,0,0,0.07), inset 0 1px 0 rgba(255,255,255,0.92)",
  };
  ...
  return (
    <>
      {/* ── Chat panel ── */}
      <div
        className="fixed z-[7999] flex flex-col rounded-3xl overflow-hidden"
      ...
      <button
        ...
        className="fixed z-[8000] flex items-center gap-2 px-4 py-3 rounded-2xl active:scale-95 transition-all duration-250"
        style={{
          bottom: "1.5rem",
          right:  "1rem",
          background:   open ? "rgba(74,100,144,0.55)" : "rgba(255,255,255,0.32)",
          ...
          borderBottom: "1px solid rgba(255,255,255,0.14)",
          boxShadow: open
            ? "0 10px 36px rgba(74,100,144,0.32), inset 0 1px 0 rgba(255,255,255,0.60)"
            : "0 8px 28px rgba(74,100,144,0.18), inset 0 1px 0 rgba(255,255,255,0.90)",
          /* No svg filter here either */
        }}
      >
        <span className="text-base leading-none" style={{ color: open ? "white" : "var(--primary)" }}>
          {open ? "\u00d7" : "\u2726"}
        </span>
        <span className="text-sm font-medium leading-none" style={{ color: open ? "white" : "var(--primary)" }}>
          {open ? "Close" : "Ask AI"}
        </span>
      </button>
    </>
