    ...
    <>
      <header className="fixed top-0 inset-x-0 z-50 flex justify-center pointer-events-none">
        <div
          ...
          style={{
            background: scrolled ? "rgba(255,255,255,0.30)" : "rgba(255,255,255,0.20)",
            ...
            boxShadow: scrolled
              ? "0 10px 48px rgba(74,100,144,0.20), 0 3px 12px rgba(0,0,0,0.08), inset 0 1px 0 rgba(255,255,255,0.92)"
              : "0 6px 28px rgba(74,100,144,0.12), inset 0 1px 0 rgba(255,255,255,0.88)",
          }}
        >
          {/* Logo */}
      ...
      <div className="fixed inset-0 z-40 md:hidden"
        ...
        <div className="absolute inset-0"
          style={{ background:"rgba(220,210,200,0.88)", backdropFilter:"blur(32px)", WebkitBackdropFilter:"blur(32px)" }}
